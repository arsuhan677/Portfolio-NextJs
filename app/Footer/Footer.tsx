            ...
            <div className="max-w-[1737px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 md:py-16 lg:py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 lg:gap-12">
                    ...
                    <div className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
                        ...
                        {/* Quick Links */}
                        <div>
                            <h3 className="text-white font-bold text-sm sm:text-base mb-4 uppercase tracking-wider">Quick Links</h3>
                            <ul className="space-y-2.5">
                                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">Home</Link></li>
                                ...
                                <li><Link href="#" className="text-xs sm:text-sm text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200">Projects</Link></li>
                ...
                <div className="max-w-[1737px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row items-center justify-center">
                        <p className="text-xs sm:text-sm text-gray-400 text-center sm:text-left">
                            © 2025 <span className="text-white font-semibold">Rahman</span>. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
